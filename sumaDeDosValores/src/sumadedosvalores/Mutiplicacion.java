 ...
 * @author josea
 */
public class Mutiplicacion extends javax.swing.JFrame {

    /**
     * Creates new form Sumatoria
     */
    public Mutiplicacion() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mutiplicacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Mutiplicacion().setVisible(true);
            }
        });
    }
