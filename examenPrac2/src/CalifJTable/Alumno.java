 ...
 */
public class Alumno {
    private String nombre, codig;
    private Float Cal1,Cal2,Cal3,Cal4, Prom;
    
    public Alumno(String codig,String Nombre, float cal1, float cal2, float cal3,float cal4, float prom){
        this.nombre=Nombre;
        this.Cal1=cal1;
        this.Cal2=cal2;
        this.Cal3=cal3;
